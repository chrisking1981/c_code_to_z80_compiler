...
// ld de, Overworld_GFX tile $2d ; cuttable tree sprite top row
    de = Overworld_GFX tile $2d ; cuttable tree sprite top row;
...
// ld de, Overworld_GFX tile $3d ; cuttable tree sprite bottom row
    de = Overworld_GFX tile $3d ; cuttable tree sprite bottom row;
...
// ld de, MoveAnimationTiles1 tile 6 ; tile depicting a leaf
    de = MoveAnimationTiles1 tile 6 ; tile depicting a leaf;
...
// ld hl, CutAnimationOffsets
    hl = CutAnimationOffsets;
// jr z, .next
// ld hl, BoulderDustAnimationOffsets
    hl = BoulderDustAnimationOffsets;
// .next
// add hl, de
// ld e, [hl]
// inc hl
