...
// ld a, [wSpritePlayerStateData2WalkAnimationCounter]
    a = wSpritePlayerStateData2WalkAnimationCounter;
// and a
...
// ld [wSpritePlayerStateData2WalkAnimationCounter], a
    wSpritePlayerStateData2WalkAnimationCounter = a;
// jr .disableSprite
...
// ld a, SPRITE_FACING_LEFT
    a = SPRITE_FACING_LEFT;
// jr .next
// .checkIfRight
// bit PLAYER_DIR_BIT_RIGHT, a
// jr z, .notMoving
// ld a, SPRITE_FACING_RIGHT
    a = SPRITE_FACING_RIGHT;
// jr .next
// .notMoving
...
// ld [wSpritePlayerStateData1IntraAnimFrameCounter], a
    wSpritePlayerStateData1IntraAnimFrameCounter = a;
// ld [wSpritePlayerStateData1AnimFrameCounter], a
    wSpritePlayerStateData1AnimFrameCounter = a;
// jr .calcImageIndex
// .next
// ld [wSpritePlayerStateData1FacingDirection], a
    wSpritePlayerStateData1FacingDirection = a;
// ld a, [wFontLoaded]
    a = wFontLoaded;
...
// ld a, [wSpritePlayerStateData1AnimFrameCounter]
    a = wSpritePlayerStateData1AnimFrameCounter;
// ld b, a
...
// ld [wSpritePlayerStateData2GrassPriority], a
    wSpritePlayerStateData2GrassPriority = a;
// ret
    return;
//
...
// jp z, UpdateSpriteMovementDelay  ; [x#SPRITESTATEDATA1_MOVEMENTSTATUS] == 2
    z, UpdateSpriteMovementDelay  ; [x#SPRITESTATEDATA1_MOVEMENTSTATUS] == 2(); /* jp */
// cp $3
// jp z, UpdateSpriteInWalkingAnimation  ; [x#SPRITESTATEDATA1_MOVEMENTSTATUS] == 3
    z, UpdateSpriteInWalkingAnimation  ; [x#SPRITESTATEDATA1_MOVEMENTSTATUS] == 3(); /* jp */
// ld a, [wWalkCounter]
    a = wWalkCounter;
// and a
...
// call LoadDEPlusA ; a = [wNPCMovementDirections + $fe] (?)
    LoadDEPlusA ; a = [wNPCMovementDirections + $fe] (?)();
...
// ld a, $6                         ; walking finished, update state
    a = $6                         ; walking finished, update state;
// add l
// ld l, a
// ld a, [hl]                       ; x#SPRITESTATEDATA2_MOVEMENTBYTE1
    a = hl;
...
// ldh a, [hIsHiddenMissableObject]
    a = hIsHiddenMissableObject;
// and a
// jp nz, .spriteInvisible
    nz, .spriteInvisible(); /* jp */
// ld h, HIGH(wSpriteStateData2)
// ldh a, [hCurrentSpriteOffset]
    a = hCurrentSpriteOffset;
...
// ld a, [wTilesetCollisionPtr]
    a = wTilesetCollisionPtr;
// ld l, a
// ld a, [wTilesetCollisionPtr+1]
    a = wTilesetCollisionPtr+1;
// ld h, a
// .tilePassableLoop
// ld a, [hli]
    a = hli;
...
// jp z, InitScriptedNPCMovement
    z, InitScriptedNPCMovement(); /* jp */
// ld hl, wNPCMovementDirections2
    hl = wNPCMovementDirections2;
// ld a, [wNPCMovementDirections2Index]
    a = wNPCMovementDirections2Index;
// add l
// ld l, a
// jr nc, .noCarry
// inc h
...
// ld [wScriptedNPCWalkCounter], a
    wScriptedNPCWalkCounter = a;
// ld hl, wNPCMovementDirections2Index
    hl = wNPCMovementDirections2Index;
// inc [hl]
// ret
    return;
//
...
// ldh a, [hSpriteVRAMSlotAndFacing]
    a = hSpriteVRAMSlotAndFacing;
// ld b, a
// ldh a, [hSpriteAnimFrameCounter]
    a = hSpriteAnimFrameCounter;
// add b
// ld [hl], a
    *hl = a;
// ret
